...
+ (instancetype)initWithJSONDictionary:(NSDictionary *)dictionary andClass:(Class)class {
    return [class createObjectFromJSONDictionary:dictionary];
}
...
+ (id)createObjectFromJSONDictionary:(NSDictionary *)dictionary {
        ...
        if (value) {
            ...
            if (transformer) {
                ...
                if ([value isKindOfClass:[NSDictionary class]]) {
                    value = [propertyClass createObjectFromJSONDictionary:value];
                }
            }
                ...
                for (id item in(NSArray*) value) {
                    [array addObject:[elementClass createObjectFromJSONDictionary:item]];
                }
                value = [array copy];
            }
